...
class Init
{
	...
	public function intro_text()
	{
		...
		echo sprintf(__('This plugin was developed by %s to turn your WordPress website into a progressive web application.', 'pwp'), '<a href="https://nicomartin.ch" target="_blank">Nico Martin</a> - <a href="https://sayhello.ch" target="_blank">Say Hello GmbH</a>');
		echo '</p><p>';
